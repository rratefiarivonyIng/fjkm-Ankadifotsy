...
cAutocomplete.prototype.initInput = function()
{
	...
	//RIJA : j'ai ajouté l possibilité de fixer la taille	
	nWidth = hInput.getAttribute( 'fieldSize' )
	if( !nWidth || nWidth == 0 )
		nWidth = 250
	//RIJA calcul taille par défaut
	...
	if( bHasButton )
	{
		...
		//RIJA hNewInput.style.width = nWidth-22
		hNewInput.style.width = nWidth
		...
		//RIJA hInputContainer.appendChild( hInputButton )
	...
	if( hInput.attachEvent )
	{
		...
		if( typeof ( hInputButton ) != "undefined")
		{
