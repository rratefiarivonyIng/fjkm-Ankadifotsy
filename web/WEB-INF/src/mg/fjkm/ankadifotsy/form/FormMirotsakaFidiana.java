 ...
 *
 */
public class FormMirotsakaFidiana {
	public static final String sfFORM_ID = "formMirotsakaFidiana";

	private MirotsakaFidiana fMirotsakaFidiana = null;
	...
	protected FormMirotsakaFidiana(){
	}
	
	public FormMirotsakaFidiana(MirotsakaFidiana mirotsakaFidiana){
		assert mirotsakaFidiana != null && mirotsakaFidiana.getMpivavaka() != null && mirotsakaFidiana.getFifidianana() != null;
		fMirotsakaFidiana = mirotsakaFidiana;
		fMpivavaka = mirotsakaFidiana.getMpivavaka();
		fFifidianana = mirotsakaFidiana.getFifidianana();
	}

	public void setMirotsakaFidiana(MirotsakaFidiana mirotsakaFidiana){
		fMirotsakaFidiana = mirotsakaFidiana;
	}
	
	public MirotsakaFidiana getMirotsakaFidiana(){
		return fMirotsakaFidiana;
	}
	...
	public Date getDatyFifidianana(){
		return fFifidianana.getDatyFifidianana();
	}
	
	public Date getDatyNirotsahana() {
		return fMirotsakaFidiana.getDatyNirotsahana();
	}

	public void setDatyNirotsahana(Date datyNirotsahana) {
		fMirotsakaFidiana.setDatyNirotsahana(datyNirotsahana);
	}
	...
	public boolean isMpandrayFrom5Years(Date date) {
		Date dateMoins5Ans = Utils.getDateMoins5Ans(date);

		return fMpivavaka.isMpandrayFrom(dateMoins5Ans);
	}

	public boolean isOlderThan25Years(Date date) {
		return fMpivavaka.isOlderThan25Years(date);
	}
	...
	public void setTaomPanompoana(TaomPanompoana taomPanompoana) {
		//ne fait rien puisqu'à ce stade le Fifidianana est déjà connu et le TaomPanompoana fixé dans le Fifidianana
	}
