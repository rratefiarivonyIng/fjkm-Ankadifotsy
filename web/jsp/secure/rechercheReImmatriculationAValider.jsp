...
<!-- debut corps -->
<form name="rechercheNifCommand" id="rechercheNifCommand" method="post" action="rechercheReImmatriculationAValider.htm">
<table width="100%">
	<tr>
	  <td>
		<ul id="tabnav">
	...
	<p></p>
	  <div class="title1" align="center" >Validation des Demandes de Réimmatriculation</div>	  
	    <table width="100%"  border="0">
          <tr>
          <spring:bind path="rechercheNifCommand.reference">
            <td width="18%">D/DE REIMMATRIC</td>
            <td width="61%">
		      ...
		      <c:forEach var="contribuable" items="${rechercheNifCommand.resultats}" varStatus="stats">
				<c:if test="${stats.count % 2 == 0}">
					<tr>
				        ...
				        <td class="tabcontenu"><a href="validationMiseAJour.htm?id=${contribuable.taxPayerNo}&reImmatriculation=1">S&eacute;lectionner</a></td>
			        </tr>
				</c:if>
				<c:if test="${stats.count % 2 != 0}">
		      		<tr>
				        ...
				        <td class="tabcontenu" bgcolor="#FFFFCC"><a href="validationMiseAJour.htm?id=${contribuable.taxPayerNo}&reImmatriculation=1">S&eacute;lectionner</a></td>
		      		</tr>
				</c:if>
		      </c:forEach>
            </table>
	...
	<tr>
	  <td><table width="100%"  border="0" align="center">
        <tr>
          <td><p align="center"><a href="listeDemandeReImmatriculation.htm?etat=1">Demandes de reimmatriculation en cours</a></p></td>
          <td><p align="center"><a href="listeDemandeReImmatriculation.htm?etat=3">Demandes de reimmatriculation Rejet&eacute;es </a></p></td>
          <td><p align="center"><a href="listeDemandeReImmatriculation.htm?etat=4">Demandes de reimmatriculation Acceptables </a></p></td>
        </tr>
      </table>	  <p>&nbsp;</p></td>
	  </tr>
</table>
