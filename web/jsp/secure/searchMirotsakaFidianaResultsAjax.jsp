...
<table width="100%">
  ...
  <tr>
    <td>
	      ...
	      <td colspan="7">
	        <table width="100%" border="1">
	          <tr>
			      ...
			      <td width="15%" bgcolor="#48A9D2"><div align="center" class="Style8"><b>Efa nirotsaka</b></div></td>
		...
		for (int i = 0; i < mpivavakas.size(); i++){
	      ...
	      <td width="12%" bgcolor="#66CCFF"><div align="center" class="Style8"><a href="editMirotsakaFidiana.htm?id=<%=mpivavaka.getId()%>&<%=ConstantUtils.sfEditedFromSearch%>=searchChristianAjax.htm?reload"><%=mpivavaka.getLaharana() != null ? mpivavaka.getLaharana() : "" %></a></div></td>
	      <td width="22%" bgcolor="#66CCFF"><div align="left" class="Style8"><a href="editMirotsakaFidiana.htm?id=<%=mpivavaka.getId()%>&<%=ConstantUtils.sfEditedFromSearch%>=searchChristianAjax.htm?reload"><%=mpivavaka.getAnarana()%></a></div></td>
	      ...
	      <td width="22%" bgcolor="#66CCFF"><div align="left" class="Style8"><%=mpivavaka.getAdresse()%></div></td>
		      <% if (mapMpivavakaId2MirotsakaFidianaId.get(mpivavaka.getId()) != null){ %>
		          <td width="15%" bgcolor="#66CCFF"><div align="center" class="Style8">
		            <a href="editMirotsakaFidiana.htm?id=<%=mpivavaka.getId()%>&mirotsakaFidianaId=<%=mapMpivavakaId2MirotsakaFidianaId.get(mpivavaka.getId())%>&<%=ConstantUtils.sfEditedFromSearch%>=searchChristianAjax.htm?reload">Eny</a></div>
		          </td>
		        ...
		        <%
		          ...
		          <td width="14%" bgcolor="#66CCFF"><div align="center" class="Style8">
		            <a href="editMirotsakaFidiana.htm?id=<%=mpivavaka.getId()%>&<%=ConstantUtils.sfEditedFromSearch%>=searchChristianAjax.htm?reload">Eny</a></div>
		          </td>
		         <%
		         }
		         else{%>
	      ...
	      <td width="12%" bgcolor="#C0C0C0"><div align="center" class="Style8"><a href="editMirotsakaFidiana.htm?id=<%=mpivavaka.getId()%>&<%=ConstantUtils.sfEditedFromSearch%>=searchChristianAjax.htm?reload"><%=mpivavaka.getLaharana() != null ? mpivavaka.getLaharana() : "" %></a></div></td>
	      <td width="22%" bgcolor="#C0C0C0"><div align="left" class="Style8"><a href="editMirotsakaFidiana.htm?id=<%=mpivavaka.getId()%>&<%=ConstantUtils.sfEditedFromSearch%>=searchChristianAjax.htm?reload"><%=mpivavaka.getAnarana()%></a></div></td>
  ...
  <tr>
    <td colspan="7"><a href="selectFifidianana.htm?id=<%=Utils.getFifidiananaFromSession(request).getId()%>">Miverina amin'ny fifidianana</a></td>
  </tr>
