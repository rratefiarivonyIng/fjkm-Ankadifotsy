  ...
  <tr>
    <td>
		...
		for (int i = 0; i < mpivavakas.size(); i++){
	      ...
	      <td width="12%" bgcolor="#66CCFF"><div align="center" class="Style8"><a href="editChristian.htm?laharana=<%=mpivavaka.getLaharana()%>&<%=ConstantUtils.sfEditedFromSearch%>"><%=mpivavaka.getLaharana() != null ? mpivavaka.getLaharana() : "" %></a></div></td>
	      <td width="22%" bgcolor="#66CCFF"><div align="left" class="Style8"><a href="editChristian.htm?id=<%=mpivavaka.getId()%>&<%=ConstantUtils.sfEditedFromSearch%>"><%=mpivavaka.getAnarana()%></a></div></td>
	      ...
	      <td width="12%" bgcolor="#C0C0C0"><div align="center" class="Style8"><a href="editChristian.htm?laharana=<%=mpivavaka.getLaharana()%>&<%=ConstantUtils.sfEditedFromSearch%>"><%=mpivavaka.getLaharana() != null ? mpivavaka.getLaharana() : "" %></a></div></td>
	      <td width="22%" bgcolor="#C0C0C0"><div align="left" class="Style8"><a href="editChristian.htm?id=<%=mpivavaka.getId()%>&<%=ConstantUtils.sfEditedFromSearch%>"><%=mpivavaka.getAnarana()%></a></div></td>
