...
<table width="100%">
	<tr><td>
		...
		<p></p>
	  <div class="title1" align="center" >Ré-immatriculation approuvable</div>
	  <p></p>
	    <table width="100%"  border="0">
          <tr>
            <td width="100%" colspan="3"><table width="100%"  border="1" class="tabliste">
              <tr>
              ...
              <c:if test="${empty contribuables}">
	      		<tr>
			        <td colspan="7" align="center"><font color="red" size="1.2">Aucune demande de mise à jour trouvée.</font></td>
	      		</tr>
              </c:if>
		      </table>
            </td>
	...
	<tr>
	  ...
	  <table width="100%"  border="0">
        <tr>
		  <td width="20%"><p>
		  <c:if test="${not empty contribuables}">
		    <a href="<%=request.getContextPath()%>/institution/resultat.csv?title=Approuvable">T&eacute;l&eacute;charger </a>
		  </c:if>
		  </p></td>          
          <td width="80%">&nbsp;</td>
        </tr>
